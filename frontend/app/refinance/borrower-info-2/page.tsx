    ...
    const loadExistingData = async () => {
      ...
      try {
        ...
        if (appData?.borrower) {
          ...
          console.log('Marital status:', borrowerData?.maritalStatus, 'type:', typeof borrowerData?.maritalStatus)
    ...
    try {
      ...
      const saveData = {
        borrower: {
          ...
          state: state,
          zipCode: zipCode,
          // Military service status and consents - ensure boolean values
          isVeteran: Boolean(formData.isVeteran),
          acceptTerms: Boolean(formData.acceptTerms),
          consentToContact: Boolean(formData.consentToContact),
        },
      }
