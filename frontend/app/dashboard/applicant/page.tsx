      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-2">
          <Button asChild variant="outline">
            <Link href="/">Purchase a Home</Link>
          </Button>
          <Button asChild variant="outline">
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <div className="flex gap-4 justify-center">
              <Button asChild>
                <Link href="/applications/new?purpose=purchase">Purchase a Home</Link>
              </Button>
              <Button asChild variant="outline">
                <Link href="/applications/new?purpose=refinance">Refinance</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
            ...
            <Card key={app.id} className="hover:shadow-md transition-shadow">
              ...
              <CardContent>
                ...
                <Button asChild variant="outline" className="w-full">
                  <Link href={`/applications/${app.id}`}>Continue Application</Link>
                </Button>
              </CardContent>
            </Card>
          ))}
