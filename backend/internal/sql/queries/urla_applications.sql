...
INSERT INTO loan_applications (
    applicant_id, user_id, application_date, loan_type, loan_purpose, property_type, property_usage,
    loan_amount_requested, down_payment_amount, term_years, interest_rate,
    amortization_type, application_status
) VALUES (
    $1, $2, CURRENT_DATE, $3, $4, $5, $6, $7, $8, $9, $10, $11, 'draft'
...
SELECT 
    loan_application_id, applicant_id, user_id, application_date, loan_type, loan_purpose, property_type,
...
SELECT 
    la.loan_application_id, la.applicant_id, la.user_id, la.application_date, la.loan_type, la.loan_purpose, 
